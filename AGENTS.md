...
- Apply `governance-trigger.md` as the lightweight ambient trigger for incoming work. Do not load the full governance system for ordinary local implementation tasks.
- When the trigger fires, begin with `project-governance/SKILL.md`, then read only the routed specialist Skill.
